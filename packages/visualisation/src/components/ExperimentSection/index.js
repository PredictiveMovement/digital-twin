  ...
  return (
    <MenuContainer>
      ...
      <ParagraphMedium black>
        Experiment-id:&nbsp;
        <strong>
          <a href={experimentUrl} target="_blank" rel="noreferrer">
            {experimentId}
          </a>
        </strong>
        <br />
