  ...
  io.on('connection', function (socket) {
    ...
    engine.bookings
      .pipe(
        ...
        map(({ destination: { position, name }, id, status, isCommercial, assignedDateTime, pickupDateTime, deliveredDateTime, queuedDateTime, }) => ({ id, name, position, status, isCommercial, deliveredDateTime, pickupDateTime, assignedDateTime, queuedDateTime })),
